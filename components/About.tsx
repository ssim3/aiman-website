          ...
          <div className="flex-3 flex flex-col gap-5">
            <div className="border-l-5 p-10 flex flex-col gap-5">
              ...
              <p className="text-lg leading-relaxed mb-6">
                A dedicated real estate professional with a passion for helping
                people find their perfect home. With over a decade of experience
                in the local market, I've built my reputation on trust,
                expertise, and exceptional customer service.
              </p>
              <p className="text-lg leading-relaxed">
                My approach is simple: listen to your needs, understand your
                dreams and work tirelessly to make them reality. Whether you're
                a first time buyer, looking to upgrade, or seeking your
                property, I'm here to guide you through every step of the
                process.
              </p>
            </div>
