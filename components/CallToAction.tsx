...
const CallToAction = () => {
  return (
    <section className="w-full flex items-center justify-center bg-gradient-to-br from-[#597CE4] to-[#4169E2]">
      <div className="w-full max-w-7xl flex flex-col md:flex-row items-center justify-between gap-12 px-6 py-16">
        ...
        <div className="w-full md:w-1/2 flex flex-col gap-5 text-white items-center md:items-start text-center md:text-left">
          <h1 className="text-4xl font-bold">
            #HAVE <span className="text-[var(--primary)]">IMAN</span> IN <span className="text-[var(--primary)]">AIMAN</span>.
          </h1>
          <p className="text-lg md:text-xl max-w-xl">
            Ready to find your dream home or need expert real estate advice? Contact Aiman today and experience the difference.
          </p>
          <a
            href={WHATSAPP_LINK}
            target="_blank"
            rel="noopener noreferrer"
            className="flex gap-3 items-center mt-5 bg-green-500 hover:bg-green-600 text-white font-semibold px-8 py-4 rounded-full text-lg shadow transition"
          >
