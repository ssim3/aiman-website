      ...
      <div className="max-w-7xl px-10 mx-auto">
        <div className="flex flex-col sm:flex-row gap-16 justify-between items-start">
          ...
          <div className='flex flex-col gap-2 max-w-lg'>
            <Image src="/aimanlogo.png" width={200} height={150} alt='Aiman Roza Logo' />
            <p className="text-gray-300 mb-6 leading-relaxed">
              Your trusted real estate partner, committed to 
              turning your property goals into reality with 
