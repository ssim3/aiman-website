  ...
  return (
    ...
    <div className="columns-1 sm:columns-2 lg:columns-3  gap-4 space-y-4">
      ...
      {reviews.map((review, idx) => (
        <div
          key={idx}
          className="break-inside-avoid rounded-2xl shadow-lg border border-gray-200 p-4 bg-white"
        >
          <div className="flex items-center gap-3 mb-2">
            ...
            />
            <div className="flex flex-col gap-1 -ml-1 items-start">
          ...
          <p className="text-gray-700">{review.text.slice(0, 500)}......</p>
        </div>
      ))}
    </div>
    </div>
