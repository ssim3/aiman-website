...
const testimonialVideos: TestimonialVideo[] = [
  {
    ...
    videoId: "10EQxWSwyv6IEExAjJtsMBEGA_nLl2nPW", // Replace with actual YouTube video ID
  },
  {
    id: "2",
    title: "Client Testimonial 2",
    videoId: "1oD0UeLigpmSvHpej_1Q2uodVzojIvrYH", // Replace with actual YouTube video ID
  },
  {
    id: "3",
    title: "Client Testimonial 3",
    videoId: "1NxEpsZJnn3hX8yI9yCnNf4s52MCX-62X", // Replace with actual YouTube video ID
  },
  {
    id: "4",
    title: "Client Testimonial 4",
    videoId: "1g31EtZ6TF0PY-qMNnAOA2eIyY4yixugv", // Replace with actual YouTube video ID
  },
];
                    ...
                    <DialogTrigger asChild>
                      <div className="cursor-pointer group relative">
                        <div className="relative aspect-video rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform">
                          <Image
                            src={`https://drive.google.com/thumbnail?id=${video.videoId}`}
                            alt={video.title}
                            fill
